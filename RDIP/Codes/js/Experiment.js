        ...
        run = function () {
            ...
            if (selection.value === "eng") {
                ...
                //Displaying randome element from randome array

                document.getElementById("val").innerHTML =engRandom[Math.floor(Math.random())]
            ...
            // For Hindi language
                ...
                document.getElementById("val").innerHTML =  hndRandom[Math.floor(Math.random())]
